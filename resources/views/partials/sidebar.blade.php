                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="reportsDropdown">
                                    <li><a class="dropdown-item" href="{{ route('reports.manage') }}">
...
{{-- <div class="col-md-2 sidebar p-0">
    ...
    <div class="p-3">
        <ul class="nav flex-column">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle {{ request()->routeIs(['reports.*', 'ViewAll', 'deductions.*', 'losses.*']) ? 'active' : '' }}"
                ...
                <ul class="dropdown-menu" aria-labelledby="reportsDropdown">
                    ...
                    <li>
                        <a class="dropdown-item {{ request()->routeIs('reports.manage') ? 'active' : '' }}"
